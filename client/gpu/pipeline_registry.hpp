...
enum class PipelineType {
    ...
    // Shadow pipelines
    Shadow,             ///< Static model shadow depth pass
    SkinnedShadow,      ///< Skinned model shadow depth pass
...
inline const char* pipeline_type_to_string(PipelineType type) {
    switch (type) {
        ...
        case PipelineType::Shadow:        return "Shadow";
        case PipelineType::SkinnedShadow: return "SkinnedShadow";
...
public:
    ...
    GPUPipeline* get_shadow_pipeline() { return get_pipeline(PipelineType::Shadow); }
    GPUPipeline* get_skinned_shadow_pipeline() { return get_pipeline(PipelineType::SkinnedShadow); }
