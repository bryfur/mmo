...
constexpr SkillInfo kWarriorSkills[] = {
    {"warrior_charge", "Charge", 8.0f},          {"warrior_ground_slam", "Ground Slam", 12.0f},
    {"warrior_battle_cry", "Battle Cry", 25.0f}, {"warrior_whirlwind", "Whirlwind", 15.0f},
    {"warrior_execute", "Execute", 20.0f},
};

constexpr SkillInfo kMageSkills[] = {
    {"mage_fireball", "Fireball", 6.0f}, {"mage_frost_nova", "Frost Nova", 10.0f},
    {"mage_blink", "Blink", 12.0f},      {"mage_arcane_rain", "Arcane Rain", 18.0f},
...
constexpr SkillInfo kArcherSkills[] = {
    {"archer_evasive_roll", "Evasive Roll", 6.0f},      {"archer_multi_shot", "Multi-Shot", 8.0f},
    {"archer_snare_trap", "Snare Trap", 15.0f},         {"archer_piercing_shot", "Piercing Shot", 10.0f},
...
const SkillInfo* skills_for_class(int class_index) {
    switch (class_index) {
        case 1:
            return kMageSkills;
        case 2:
            return kPaladinSkills;
        case 3:
            return kArcherSkills;
        default:
            return kWarriorSkills;
    }
}
